    ...
    <Modal size="sm" isOpen={show} toggle={onCloseClick} centered={true}>
      <div className="modal-content">
        <ModalBody className="px-4 py-5 text-center">
          ...
          <p className="text-muted font-size-16 mb-4">Are you sure you want to permanently erase the contact.</p>

          <div className="hstack gap-2 justify-content-center mb-0">
            <button type="button" className="btn " style={{ backgroundColor: "#721E81", color: "white" }}

              onClick={onDeleteClick}>Delete Now</button>
