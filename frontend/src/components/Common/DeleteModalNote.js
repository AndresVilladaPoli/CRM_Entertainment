...
const DeleteModalNote = ({ show, onDeleteClick, onCloseClick }) => {
  return (
    <Modal size="sm" isOpen={show} toggle={onCloseClick} centered={true}>
      <div className="modal-content">
        <ModalBody className="px-4 py-5 text-center">
          ...
          <p className="text-muted font-size-16 mb-4">The note was deleted successfully!</p>
...
DeleteModalNote.propTypes = {
  onCloseClick: PropTypes.func,
  onDeleteClick: PropTypes.func,
  show: PropTypes.any
}
export default DeleteModalNote
